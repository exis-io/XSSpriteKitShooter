...
class GameScene: SKScene, SKPhysicsContactDelegate, Delegate {
  ...
  func addMonster(speed: Double) {
    ...
    let actualDuration = 5.0 - CGFloat(speed)
  ...
  func didBeginContact(contact: SKPhysicsContact) {
    ...
    monstersDestroyed++
    app.publish("monsterKilled", self.monstersDestroyed)
